...
def research_question():
    ...
    utils.create_directory("../output/rqs/")
    ...
    __developer_distribution(dev_less_5, dev_bt_5_10, dev_gt_10)
    __developer_conflict_distribution(cn_dev_less_5, cn_dev_bt_5_10, cn_dev_gt_10)
    ...
    __chunks_distribution(chunks_less_50, chunks_bt_50_100, chunks_gt_100)
    __chunks_conflict_distribution(cn_chunks_less_50, cn_chunks_bt_50_100, cn_chunks_gt_100)
    ...
    __top_occasional_project_level(dev5, dev10, dev15, chunks50, chunks100, chunks150, chunks_branch_data)

    # Top and occ. contributors at branch-level (Research Question #1.2)
    __top_occasional_branch_level(dev5, dev10, dev15, chunks50, chunks100, chunks150, chunks_branch_data)

    # Research Question #2
    # Top and occ. contributors at project- and branch-level touch Target (Research Question #2.1)
    __top_occ_dev_target(dev_branch_data, chunks_branch_data)

    # Top and occ. contributors at project- and branch-level touch Source (Research Question #2.2)
    __top_occ_dev_chunks_source(dev_branch_data, chunks_branch_data)

    print("research_question executed")


# DEVELOPER DISTRIBUTION
def __developer_distribution(dev_less_5, dev_bt_5_10, dev_gt_10):
    ...
    plt.savefig('../output/rqs/Developers_Distribution')
    # plt.show()


# DEVELOPER CONFLICTS DISTRIBUTION
def __developer_conflict_distribution(cn_dev_less_5, cn_dev_bt_5_10, cn_dev_gt_10):
    fig, ax = plt.subplots(figsize=(10, 7), subplot_kw=dict(aspect="equal"))
    ...
    plt.savefig('../output/rqs/Developers_Conflicts_Distribution')
    # plt.show()


# CHUNKS DISTRIBUTION
def __chunks_distribution(chunks_less_50, chunks_bt_50_100, chunks_gt_100):
    fig, ax = plt.subplots(figsize=(10, 7), subplot_kw=dict(aspect="equal"))
    ...
    plt.savefig('../output/rqs/Chunks_Distribution')
    # plt.show()


# CHUNKS CONFLICTS DISTRIBUTION
def __chunks_conflict_distribution(cn_chunks_less_50, cn_chunks_bt_50_100, cn_chunks_gt_100):
    fig, ax = plt.subplots(figsize=(10, 7), subplot_kw=dict(aspect="equal"))
    ...
    plt.savefig('../output/rqs/Chunks_Conflicts_Distribution')
    # plt.show()


# (Research Question #1.1)
def __top_occasional_project_level(dev5, dev10, dev15, chunks50, chunks100, chunks150, chunks_branch_data):
    report_data.clear()
    ...
    df.to_csv('../output/rqs/RQ1.1_Results.csv')


# (Research Question #1.2)
def __top_occasional_branch_level(dev5, dev10, dev15, chunks50, chunks100, chunks150, chunks_branch_data):
    report_data.clear()
    ...
    df = pd.DataFrame(report_data, columns=column_names)
    df.to_csv('../output/rqs/RQ1.2_Results.csv')


# (Research Question #2.1)
def __top_occ_dev_target(dev_branch_data, chunks_branch_data):
    report_data.clear()
    ...
    df = pd.DataFrame(report_data, columns=column_names)
    df.to_csv('../output/rqs/RQ2.1_Results.csv')


# (Research Question #2.2)
def __top_occ_dev_chunks_source(dev_branch_data, chunks_branch_data):
    report_data.clear()
    ...
    df = pd.DataFrame(report_data, columns=column_names)
    df.to_csv('../output/rqs/RQ2.2_Results.csv')