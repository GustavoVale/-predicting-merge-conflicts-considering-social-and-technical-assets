...
class DNN:
    ...
    def __is_valid_object(self):
        return None not in [self.learning_rates, self.dropout_rates, self.neurons_denses, self.hidden_layers, self.epochs, self.batch_sizes, self.activations]
                                ...
                                for epochs in self.epochs:
                                    for batch_size in self.batch_sizes:
                                        for activation in self.activations:
                                            ...
                                            print(technique, learning_rate, dropout_rate, None, neurons_dense, hidden_layers, epochs, batch_size,
                                                activation)
                                            hyper_parameters = "learning_rate:", learning_rate, " dropout_rate:", dropout_rate, " neurons_dense:", neurons_dense, \
                                                " hidden_layers:", hidden_layers, " epochs:", epochs, " batch_size:", batch_size, " activation:", activation
                                            
                                            datamodel = keras_helper.keras_model(algorithm, mode, learning_rate, dropout_rate, None, neurons_dense, hidden_layers,
                                                                            epochs, batch_size, activation, x_train, y_train, None)
