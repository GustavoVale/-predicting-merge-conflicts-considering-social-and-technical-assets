...
class LSTM:
    ...
    def __is_valid_object(self):
        return None not in [self.learning_rates, self.dropout_rates, self.units, self.neurons_denses, self.hidden_layers, self.epochs, self.batch_sizes, self.activations]
